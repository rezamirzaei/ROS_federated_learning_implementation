...
try:
    from fl_robots_interfaces.msg import ModelWeights, TrainingMetrics, RobotStatus, AggregationResult
    from fl_robots_interfaces.srv import RegisterRobot, TriggerAggregation, GetModelInfo, UpdateHyperparameters
