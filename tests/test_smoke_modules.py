...
def test_cli_build_parser_round_trip() -> None:
...
def test_digital_twin_constructs_and_serializes_state(fake_ros: Any) -> None:
...
def test_monitor_node_constructs_and_receives_status(fake_ros: Any, tmp_path: Any) -> None:
